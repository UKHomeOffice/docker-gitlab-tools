...
We've noticed your two-factor authentication is not enabled for you Gitlab account. For reasons of security two factor authentication 
    ...
    def default_options
      {
        ...
        :password       => nil,
        :dryrun         => true,
        :email          => "mail.default.cluster.local",
        :ignore         => [],
        :include        => [],
        :from_address   => nil,
      }
